...
- [S-10：0.4.0 多后端与 WebGPU](S-10-0.4.0-webgpu-backend.md)——已完成；桌面 WebGPU、静态
...
- [S-15：私有 HAL 结构整理](S-15-internal-hal-structure.md)——实现完成；已集中后端能力发现与
  Registry 依赖，并整理 HAL 契约和具体后端目录；Linux 最终验收随 S-16 执行。
