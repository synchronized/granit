...
- 设计状态：已确认
- 实现状态：进行中（H-02E3A～H-02E3B、H-02E3C1 已完成）
- 路线图任务：H-02E3
- 优先级：P2
- 前置依赖：H-02E1、H-02E2
- 后续依赖：H-02F、H-02G
...
3. **H-02E3C（进行中）**：H-02E3C1 已将现有 `material_package` 确定性编码为 String、参数、
   Feature、Pass、Variant、Shader 和 SPIR-V 七个核心区段；下一步实现语义解码与完整往返验证。
