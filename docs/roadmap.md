...
**状态：进行中。H-01～H-03 已完成，下一步进入 H-04 场景输入适配层。**
...
- **[H-04](plans/H-04-scene-submission.md) / P2 / 进行中**：H-04A～H-04C 已完成快照、CPU Frustum、
  多 View 与逐 View 光源筛选；下一步接入 PBR Render Graph Pass。
