...
| 五、基础渲染 | 进行中 | D-10F 公共限制查询等待跨平台验收；D-09 等待真实 Bindless 瓶颈 |
...
**状态：进行中；D-10A 至 D-10E 已验收，D-10F 公共限制查询等待跨平台验收。**
...
| [D-10 动态 Uniform Buffer Offset](plans/D-10-dynamic-uniform-buffer-offsets.md) | P1 | D-10F 验证中 |
