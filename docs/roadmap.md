...
| [H-08 公共 UI、Debug Draw 与 Text](plans/H-08-ui-debug-text-components.md) | P2 | 进行中；H-08A～H-08B、H-08C1～H-08C3b2 已完成 |
...
1. 完成 H-08C3c：把世界 Debug Draw 接入参考 Render Pipeline 的逐 View 提交路径。
