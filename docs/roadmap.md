...
| [H-08 公共 UI、Debug Draw 与 Text](plans/H-08-ui-debug-text-components.md) | P2 | 进行中；H-08A～H-08B、H-08C1～H-08C3a 已完成 |
...
1. 实现 H-08C3b：建立世界 Debug Draw Shader、深度分组与公共录制接口。
