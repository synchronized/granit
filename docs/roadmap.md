...
**状态：进行中。H-01、H-02 已完成内部原型，当前进入 H-03。**
...
- **[H-03](plans/H-03-pbr-renderer.md) / P2 / 进行中**：已确定首版为离屏、前向、不透明、单方向
  光；H-03A～H-03D 已完成，下一步接入显式 View/Object/Directional Light 输入与 Render Graph
  Pass。
