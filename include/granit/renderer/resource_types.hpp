...
enum class texture_format : std::uint32_t {
  ...
  bc1_rgba_unorm = GRANIT_TEXTURE_FORMAT_BC1_RGBA_UNORM,
  bc1_rgba_srgb = GRANIT_TEXTURE_FORMAT_BC1_RGBA_SRGB,
  bc3_rgba_unorm = GRANIT_TEXTURE_FORMAT_BC3_RGBA_UNORM,
  bc3_rgba_srgb = GRANIT_TEXTURE_FORMAT_BC3_RGBA_SRGB,
  bc5_rg_unorm = GRANIT_TEXTURE_FORMAT_BC5_RG_UNORM,
  bc7_rgba_unorm = GRANIT_TEXTURE_FORMAT_BC7_RGBA_UNORM,
  bc7_rgba_srgb = GRANIT_TEXTURE_FORMAT_BC7_RGBA_SRGB,
  etc2_rgba8_unorm = GRANIT_TEXTURE_FORMAT_ETC2_RGBA8_UNORM,
  etc2_rgba8_srgb = GRANIT_TEXTURE_FORMAT_ETC2_RGBA8_SRGB,
  astc_4x4_unorm = GRANIT_TEXTURE_FORMAT_ASTC_4X4_UNORM,
  astc_4x4_srgb = GRANIT_TEXTURE_FORMAT_ASTC_4X4_SRGB,
};
