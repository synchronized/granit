...
#define GRANIT_BINDING_TYPE_SAMPLED_TEXTURE_CUBE UINT32_C(7)
#define GRANIT_BINDING_TYPE_STORAGE_TEXTURE UINT32_C(4)
#define GRANIT_BINDING_TYPE_SAMPLER UINT32_C(5)
#define GRANIT_BINDING_TYPE_COMPARISON_SAMPLER UINT32_C(8)
#define GRANIT_BINDING_TYPE_SAMPLED_DEPTH_TEXTURE UINT32_C(9)
