...
public:
  webgpu_shader_adapter(webgpu_context& context, webgpu_instance_handle instance);
  ...
  [[nodiscard]] webgpu_shader native_handle(backend_shader_resource& resource) const noexcept;
