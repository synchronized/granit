...
#ifndef GRANIT_BACKEND_VULKAN_READBACK_CONTEXT_H_
#define GRANIT_BACKEND_VULKAN_READBACK_CONTEXT_H_
...
/** 可重复使用的异步回读对象集合。外部必须保证同一时刻只有一个线程使用。 */
class vulkan_readback_context {
public:
