...
class vulkan_renderer_state;

class vulkan_buffer_resource final : public backend_buffer_resource {
public:
  explicit vulkan_buffer_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
private:
  std::shared_ptr<vulkan_renderer_state> renderer_;
  vulkan_buffer_allocation native_{};
};

class vulkan_texture_resource final : public backend_texture_resource {
public:
  explicit vulkan_texture_resource(std::shared_ptr<vulkan_renderer_state> renderer,
...
public:
  explicit vulkan_texture_view_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_sampler_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_shader_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_bind_group_layout_resource(
...
public:
  explicit vulkan_bind_group_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_pipeline_layout_resource(
      std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_graphics_pipeline_resource(
      std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_compute_pipeline_resource(
      std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_command_recorder_resource(
      std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_surface_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_swapchain_resource(std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
...
public:
  explicit vulkan_timestamp_query_pool_resource(
      std::shared_ptr<vulkan_renderer_state> renderer) noexcept;
