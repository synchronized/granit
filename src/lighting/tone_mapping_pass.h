...
using tone_mapping_record_callback = std::function<granit_result(
    render_graph::pass_context&, const tone_mapping_constants&)>;
...
[[nodiscard]] render_graph::pass_id add_tone_mapping_graph_pass(
    render_graph::serial_graph& graph, tone_mapping_graph_pass_desc desc,
    tone_mapping_record_callback callback, std::string name = "Tone Mapping");
