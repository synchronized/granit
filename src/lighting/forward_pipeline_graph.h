...
#ifndef GRANIT_LIGHTING_FORWARD_PIPELINE_GRAPH_H
#define GRANIT_LIGHTING_FORWARD_PIPELINE_GRAPH_H
...
struct forward_pipeline_graph_desc {
...
enum class forward_pipeline_graph_error : std::uint8_t {
  none,
  invalid_resource,
  invalid_callback,
 ...
 */
[[nodiscard]] forward_pipeline_graph_error
add_forward_pipeline_graph(render_graph::serial_graph& graph, forward_pipeline_graph_desc desc,
                           forward_pipeline_graph_callbacks callbacks,
                           forward_pipeline_graph_passes& output,
                           std::string name_prefix = "Forward Pipeline");
