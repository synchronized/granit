...
granit_result restore_shader_object_cache(const shader_object_cache_context& context,
  ...
  try {
    ...
    if (granit::detail::shader_format::decode_shader_object(read_bytes(context.object_path), object) !=
    ...
    if (granit::detail::shader_format::validate_shader_object_payloads(object, wgsl, spirv) !=
        granit::detail::shader_format::shader_object_error::success)
      return GRANIT_SUCCESS;
...
granit_result write_shader_object_cache(const shader_object_cache_context& context,
  ...
  try {
    ...
    if (granit::detail::shader_format::encode_shader_object(
      ...
      return GRANIT_ERROR_INVALID_ARGUMENT;
    if (granit::asset_tools::detail::store_shader_object(context.object_path, object, wgsl, spirv, cache_hit) !=
        granit::detail::shader_format::shader_object_error::success)
      return GRANIT_ERROR_INITIALIZATION_FAILED;
    return GRANIT_SUCCESS;
  } catch (const std::bad_alloc&) {
