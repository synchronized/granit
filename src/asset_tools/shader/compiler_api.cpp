...
struct stored_shader_data {
  ...
  std::vector<granit::asset_tools::detail::shader_binding_info> bindings;
  std::vector<granit::asset_tools::detail::shader_interface_variable_info> vertex_inputs;
  std::vector<granit::asset_tools::detail::shader_interface_variable_info> fragment_outputs;
  std::vector<granit::asset_tools::detail::shader_override_info> overrides;
...
uint32_t binding_type_value(granit::asset_tools::detail::shader_binding_type type) {
  using enum granit::asset_tools::detail::shader_binding_type;
  switch (type) {
  case uniform_buffer:
...
uint32_t binding_access_value(granit::asset_tools::detail::shader_binding_access access) {
  using enum granit::asset_tools::detail::shader_binding_access;
  switch (access) {
  case read:
...
uint32_t scalar_type_value(granit::asset_tools::detail::shader_scalar_type type) {
  using enum granit::asset_tools::detail::shader_scalar_type;
  switch (type) {
  case floating_point:
