...
TEST_CASE("共享库导出完整的公共 C ABI", "[abi][exports]") {
  ...
  INFO("可选 component ABI 快照: " << GRANIT_ABI_OPTIONAL_SNAPSHOT_VERSION);
  ...
  check_exports("AssetTools", GRANIT_ABI_ASSET_TOOLS_LIBRARY_PATH,
                GRANIT_ABI_ASSET_TOOLS_SYMBOLS_PATH);
}
