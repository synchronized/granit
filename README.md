...
> **最新发布版本：0.36.0。** 0.x 不保证 API/ABI 稳定；升级前请阅读
...
[Granit 0.36.0 Release](https://github.com/synchronized/granit/releases/tag/v0.36.0) 含 Windows/Linux x64 SDK 及 `SHA256SUMS`；
