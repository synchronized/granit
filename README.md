...
参考实现和 HLSL 离屏绘制；PBR 材质常量、五类纹理、默认资源、编译期裁剪变体和顶点输入契约
...
H-05 已完成：内部 `granit::lighting` 提供有界多光源打包、单方向光阴影、split-sum
...
Asset 工具负责。统一 Render Graph 组合、2,000 帧生命周期压力测试，以及 Windows/Linux、
Clang/GCC/MSVC、共享/静态安装 Consumer 均已验证。下一步进入公共 C ABI 收敛检查点与 H-07。
