...
> **最新发布版本：0.35.0。** 0.x 不保证 API/ABI 稳定；升级前请阅读
...
| [Window](docs/reference/window.md) | `granit::window` | 0.x，未冻结 | Win32、XCB、Wayland、浏览器窗口、输入与 Surface 接入 |
...
[Granit 0.35.0 Release](https://github.com/synchronized/granit/releases/tag/v0.35.0) 含 Windows/Linux x64 SDK 及 `SHA256SUMS`；
...
顶层构建默认同时生成示例和测试。Windows Clang 配置完成后可运行内部离屏 GPU Smoke：
