...
> **最新发布版本：0.31.0。** 0.x 不保证 API/ABI 稳定；升级前请阅读
...
[Granit 0.31.0 Release](https://github.com/synchronized/granit/releases/tag/v0.31.0) 含 Windows/Linux x64 SDK 及 `SHA256SUMS`；
